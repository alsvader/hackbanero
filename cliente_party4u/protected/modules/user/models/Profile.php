...
class Profile extends UActiveRecord
{
	...
	public function relations()
	{
		...
		$relations = array(
			...
			'depto'=>array(self::BELONGS_TO, 'Departamento', 'id_departamento'),
			'privilegio'=>array(self::BELONGS_TO, 'Privilegio', 'id_privilegio'),
			'oficina'=>array(self::BELONGS_TO, 'SubDepartamento', 'id_sub'),
		);
