...
class UsuariosController extends Controller
{
	...
	public $url_server="party4u.herokuapp.com/";
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['PrimeraSesion']))
		{
			$model->attributes=$_POST['PrimeraSesion'];
			if($model->save())
	...
	{
		$model=new PrimeraSesion('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['PrimeraSesion']))
			$model->attributes=$_GET['PrimeraSesion'];
	...
	{
		$model=PrimeraSesion::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='primera-sesion-form')
		{
